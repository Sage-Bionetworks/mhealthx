...
# We load the mhealthx release info into a dict by explicit execution
rel = {}
execfile('../mhealthx/info.py', rel)
...
project = 'mhealthx'
copyright = 'Sage Bionetworks team'
...
#latex_documents = [
#  ('documentation', 'mhealthx.tex', 'Neuroimaging in Python Documentation',
